...
#define DATA_PIN    13        //pino do arduino conectado a fita de LEDS WS2812B
...
#define FRAMES_PER_SECOND  100   //frames por segundo, quanto mais leds na fita menor deve ser a taxa de frames por segundo
